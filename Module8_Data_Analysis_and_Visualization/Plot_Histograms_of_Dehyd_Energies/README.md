### Directory Overview:
This directory contains Jupyter Notebooks used to render histograms of arynes by DFT-calculated dehydration energies.
...
### Aryne Ring size vs. DFT-calculated dehydration energy:
